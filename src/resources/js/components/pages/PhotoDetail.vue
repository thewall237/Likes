...
<script>
import { OK, CREATED, UNPROCESSABLE_CONTENT } from "../../util";
    ...
    methods: {
        ...
        async addComment() {
            const response = await axios.post(
                `/api/photos/${this.$route.params.id}/comments`,
                {
        ...
        async like() {
            const response = await axios.put(`/api/photos/${this.$route.params.id}/like`);
        ...
        async unlike() {
            const response = await axios.delete(`/api/photos/${this.$route.params.id}/like`);
